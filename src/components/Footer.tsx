    ...
    <footer className="bg-olive-dark text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-playfair font-bold mb-4 text-olive-light">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href={`tel:${textContent?.contactInfo.phone}`} className="flex items-center gap-2 text-gray-200 hover:text-olive-light transition-colors">
                <Phone size={18} />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-200 hover:text-olive-light transition-colors">
                  {textContent?.header.home || 'Accueil'}
                </Link>
              </li>
              <li>
                <Link to="/products" className="text-gray-200 hover:text-olive-light transition-colors">
